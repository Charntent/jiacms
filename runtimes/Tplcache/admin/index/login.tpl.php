...
.frame .top{ background:#267cb7;#222222;#323841; height:154px;
	 ...
	 border-bottom:0}
.login{ width:396px; height:303px; padding-top:56px; *padding-top:50px;/* background:url(<?php echo $skins_admin ?>/login.png) no-repeat;*/ border:none; box-shadow:none}
...
<div class="frame login_wrap">
	...
	<div class="login">
		<form name="form1" method="post" action="<?php echo U($m.'/index') ?>" class="form">
		<input name="action" type="hidden" value="login">
		<table width="280" border="0" cellspacing="0" cellpadding="0" align="center" style="">
        <tr height="46">
				<td align="center"><img src="<?php echo $skins_admin ?>/logo_ui5_white.png"></td>
			...
			<tr height="52">
				...
				<td><input name="checkcode" type="text" class="form-control" style="width:170px; float:left" placeholder="验证码" required > <img src="<?php echo U($m.'/checkcode') ?>" onClick="this.src='<?php echo U($m.'/checkcode') ?>?'+Math.random()" style="cursor:pointer; height:42px; width:110px" /> </td>
			</tr>
    ...
    color: #83b7ce;
    line-height: 1.8em;">版权所有 深圳市慧名科技有限公司 Copyright © 2014 - <?php echo date('Y') ?> huimingai.com Inc. All Rights Reserved.
