...
<div class="row">
  <div class="col-lg-12">
    <ol class="breadcrumb">
      <li> <i class="glyphicon glyphicon-home"></i> <a href="{U($m.'/admin')}?action=homepage">JIACMS后台</a></li>
...
<div class="row">
  <div class="col-lg-12">
     ...
     <div class="alert alert-info alert-dismissable">
      ...
      {$_SESSION.admin_username}你好，欢迎来到美藤科技后台管理系统！
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body panel-body-297px">
        <ul class="list-group">
          <li class="list-group-item">HI ，<span style="color: #cc0000;">{$_SESSION.admin_username}</span> ，欢迎您登陆美藤科技后台管理系统。 </li>
          ...
          <li class="list-group-item">当前版本 　　[<a href="http://cms.jiacms.com" target="_blank">{eval echo VERSION;}</a>]<span class="pull-right"><a href="http://cms.jiacms.com" class="more" target="_blank"><span>查看更多</span><i class="fa fa-arrow-circle-right"></i></a></span></li>
...
<div style="margin:10px 30px 0px; padding-bottom:20px;">深圳美藤科技有限公司（<a href="http://www.ziyouteng.com" target="_blank">www.ziyouteng.com</a>）版权所有 &copy; 2014-{date("Y")}</div>
<!-- 右侧扩展功能 -->
