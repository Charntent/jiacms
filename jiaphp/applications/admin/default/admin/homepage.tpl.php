...
<div class="row">
  <div class="col-lg-12">
     ...
     <div class="alert alert-info alert-dismissable">
      ...
      {$_SESSION.admin_username}你好，欢迎来到慧名科技后台管理系统！
  ...
  <div class="col-md-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body panel-body-297px">
        <ul class="list-group">
          <li class="list-group-item">HI ，<span style="color: #cc0000;">{$_SESSION.admin_username}</span> ，欢迎您登陆慧名科技后台管理系统。 </li>
...
<div style="margin:10px 30px 0px; padding-bottom:20px;">深圳慧名科技有限公司（<a href="http://www.8888i.com" target="_blank">www.8888i.com</a>）版权所有 &copy; 2014-{date("Y")}</div>
<!-- 右侧扩展功能 -->
